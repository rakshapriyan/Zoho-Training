...
public class StringBuilderTask {
   ...
   public StringBuilder getStringBuilder() throws InvalidInputException{
    ...
    //Q3 -> 
    public static StringBuilder insertInBetweenWithDelimiter(StringBuilder sb, String delimiter, String insertString, int insertPos, int size) throws InvalidInputException {
        HelperUtil.isNull(sb);
        HelperUtil.isNull(delimiter);
    ...
    //Q4 ->
    public static StringBuilder deleteAtPosition(StringBuilder sb, int deletePos, String delimiter, int size) throws InvalidInputException {
        HelperUtil.isNull(sb);
        HelperUtil.isNull(delimiter);
    ...
    //Q5 ->
    public static StringBuilder replaceDelimiter(StringBuilder sb, String replace, String delimiter) throws InvalidInputException {
    	HelperUtil.isNull(sb);
